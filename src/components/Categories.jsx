...
const MenContainer = styled.div`
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
    url("https://cdn.pixabay.com/photo/2021/03/03/06/19/businessman-6064550_1280.jpg");
...
const WomenContainer = styled.div`
  ...
  /* width: 50%; */
  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
    url("https://cdn.pixabay.com/photo/2015/07/28/09/18/girl-864107_1280.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: 50% 50%;
  display: flex;
...
const Categories = () => {
  ...
  return (
    <>
      ...
      <Container>
        {cats.map((item, index) => (
          <CategoryItem item={item} key={`${item.id}_${index}`} />
        ))}
      </Container>
    </>
  );
